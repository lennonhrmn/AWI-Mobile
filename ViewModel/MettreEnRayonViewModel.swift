...
class MettreEnRayonViewModel: ObservableObject {
    ...
    func fetchGames() {
        ...
        guard let url = URL(string: "https://depot-vente-api.losherrmannos.duckdns.org/api/stocks") else {
    ...
    func moveToRayon(game: Game) {
        ...
        let body: [String: String] = ["status": "rayon"]
            ...
            DispatchQueue.main.async {
                ...
                if httpResponse.statusCode == 200 {
                    ...
                    self.alertItem = AlertItem(
                        title: "Succès",
                        message: "Le jeu '\(game.name)' a été mis en rayon avec succès."
                    )
                } else {
