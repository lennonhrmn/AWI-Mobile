...
class RetirerRayonViewModel: ObservableObject {
    ...
    func retireFromRayon(game: Game) {
        isLoading = true
        ...
        let body: [String: String] = ["status": "stock"]
            ...
            DispatchQueue.main.async {
                ...
                if httpResponse.statusCode == 200 {
                    ...
                    self.alertItem = AlertItem(
                        title: "Succès",
                        message: "Le jeu '\(game.name)' a été retiré du rayon avec succès."
                    )
                } else {
